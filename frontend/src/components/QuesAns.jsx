...
const QuesAns = () => {
    ...
    useEffect(() => {
        const fetchQuestions = async () => {
            try {
                const response = await axios.get(`${import.meta.env.VITE_API_BASE_URL}/commonQuestions/${id}`);
    ...
    const handleSubmitAnswer = async (e) => {
        ...
        try {
            ...
            await axios.post(`${import.meta.env.VITE_API_BASE_URL}/commonQuestions/answers/${id}`, {
    ...
    const handleDeleteAnswer = async () => {
        ...
        try {
            ...
            const vote = await axios.get(`${import.meta.env.VITE_API_BASE_URL}/vote/${user.username}/${id}/${answerToDelete}/votehistory`);
            console.log(vote);
            if(!vote.data)await axios.delete(`${import.meta.env.VITE_API_BASE_URL}/vote/${id}/${answerToDelete}/delete_all_votes`);

            await axios.delete(
                `${import.meta.env.VITE_API_BASE_URL}/commonQuestions/${id}/answers/${answerToDelete}`,
                { headers: { Authorization: `Bearer ${token}` } }
            );
    ...
    //         const vote = await axios.get(`${import.meta.env.VITE_API_BASE_URL}/vote/${user.username}/${id}/${answerId}/votehistory`);

    //         if(vote.data.success == false)
    //         {
    //             //downvote ++ ho gaya
    //             await axios.post(
    //                 `${import.meta.env.VITE_API_BASE_URL}/commonQuestions/${id}/answers/${answerId}/vote`,
    //                 {action : "downvote"},
    //                 { headers: { Authorization: `Bearer ${token}` } }
    //             );

    //             // data base mai user ki entry ho gayi
    //             await axios.post(`${import.meta.env.VITE_API_BASE_URL}/vote/${id}/answers/${answerId}/votehistory`,
    //                 {
    ...
    //             await axios.post(
    //                 `${import.meta.env.VITE_API_BASE_URL}/commonQuestions/${id}/answers/${answerId}/reduce_vote`,
    //                 action,
    //                 { headers: { Authorization: `Bearer ${token}` } }
    //             );

    //             //database mai se entry remove ho gayi
    //             await axios.delete(`${import.meta.env.VITE_API_BASE_URL}/vote/${user.username}/${id}/${answerId}/delete`);
    //         }
    ...
    //             await axios.put(`${import.meta.env.VITE_API_BASE_URL}/vote/${user.username}/${id}/${answerId}/update`,
    //                 {action : "downvote"}
    //             );
