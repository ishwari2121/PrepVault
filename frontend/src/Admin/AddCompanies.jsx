...
const AdminCompanyDashboard = () => {
  ...
  const handleUpdate = async (e) => {
    ...
    try {
      const response = await axios.post(
        `http://localhost:5000/api/companies/${selectedCompany.name}/recruitment`,
  ...
  const addEligibilityCriteria = async (e) => {
    ...
    try {
      const response = await axios.post(
        `http://localhost:5000/api/companies/${selectedCompany.name}/eligibility`,
  ...
  const selectCompany = async (companyName) => {
    try {
      const response = await axios.get(`http://localhost:5000/api/companies/${companyName}`);
